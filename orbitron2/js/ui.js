...
class UIManager {
    ...
    showScreen(screen) {
        ['mainMenu', 'upgradeShop', 'achievementScreen', 'levelUpScreen', 'deathScreen', 'permStashScreen', 'preRunScreen', 'dropRateScreen', 'petalInfoScreen'].forEach(s => {
