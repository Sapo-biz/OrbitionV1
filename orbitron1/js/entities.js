...
class Player {
    ...
    get maxHp() {
        return (this.baseStats.maxHp + this.statBonuses.maxHp) * (1 + this.game.permBonus('pMaxHp'));
    }
    get hpRegen() {
        return (this.baseStats.hpRegen + this.statBonuses.hpRegen) * (1 + this.game.permBonus('pRegen'));
    }
    get speed() {
...
class Enemy {
    constructor(x, y, typeKey, waveScale = 1, isBoss = false, bossData = null) {
        ...
        this.hp = this.maxHp;
        this.damage = base.damage * waveScale * 0.8;
